...
int main(int argc, char **argv)
{
  ...
  // turnips.basePrice, turnips.basePrice, turnips.sellPrices[2], turnips.sellPrices[3], turnips.sellPrices[4], turnips.sellPrices[5], turnips.sellPrices[6], turnips.sellPrices[7], turnips.sellPrices[8], )

  printf("%3d, %3d, ", turnips.basePrice, turnips.basePrice);
  for(int i = 2; i < 14; i++)
  {
    if(i == 13){
      printf("%3d", turnips.sellPrices[i]);
    }
    else
    {
      printf("%3d, ", turnips.sellPrices[i]);
